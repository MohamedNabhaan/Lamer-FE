...
import { API_ENDPOINTS, getApiUrlWithId } from "../config/api.js";
...
export default function SiteEditForm() {
  ...
  // Initialize key features from existing site data
  const [keyFeatures, setKeyFeatures] = useState(() => {
    if (site.keyFeatures && site.keyFeatures.trim()) {
      return site.keyFeatures
        .split(",")
        .map((item) => item.trim())
        .filter((item) => item !== "");
    }
  ...
  const [currentImages, setCurrentImages] = useState({
    sitePicture1: site.sitePicture1 || null,
    sitePicture2: site.sitePicture2 || null,
    sitePicture3: site.sitePicture3 || null,
  });
  ...
  const clearPicture = (pictureField) => {
    ...
    if (pictureField === "sitePicture1") {
      ...
      if (sitePictures.sitePicture2 || previewImages.sitePicture2)
        picturesToClear.push("sitePicture2");
      if (sitePictures.sitePicture3 || previewImages.sitePicture3)
  ...
  const removeCurrentImage = (pictureField) => {
    const picturesToRemove = [];

    // Determine which pictures to remove based on the field
    if (pictureField === "sitePicture1") {
      // If Picture 1 is removed, also remove Pictures 2 and 3
      picturesToRemove.push("sitePicture1");
      if (currentImages.sitePicture2) picturesToRemove.push("sitePicture2");
      if (currentImages.sitePicture3) picturesToRemove.push("sitePicture3");
    } else if (pictureField === "sitePicture2") {
      // If Picture 2 is removed, also remove Picture 3
      picturesToRemove.push("sitePicture2");
      if (currentImages.sitePicture3) picturesToRemove.push("sitePicture3");
    } else {
      // Just remove Picture 3
      picturesToRemove.push("sitePicture3");
    }

    // Update state for all pictures to remove
    setCurrentImages((prev) => {
      const newState = { ...prev };
      picturesToRemove.forEach((field) => {
        newState[field] = null;
      });
      return newState;
    });
  ...
  function handleSubmit(e) {
    ...
    // Add flags to indicate which current images should be removed
    Object.keys(currentImages).forEach((key) => {
      if (currentImages[key] === null && site[key]) {
        // Image was removed
              ...
              <Box>
                ...
                <SimpleGrid columns={{ base: 1, md: 1 }} spacing={6}>
                  ...
                  >
                    ...
                    {currentImages.sitePicture1 &&
                      !previewImages.sitePicture1 && (
                        <Box position="relative" mb={3}>
                          ...
                          <Image
                            src={currentImages.sitePicture1}
                            alt="Current site picture 1"
                            maxH="200px"
                            w="100%"
                            objectFit="cover"
                            borderRadius="md"
                    ...
                    {/* Upload Area or New Image Preview */}
                    {!previewImages.sitePicture1 ? (
                      <Box
                        border="1px dashed"
                        borderColor={
                      ...
                      <Box>
                        ...
                        <Box position="relative">
                          <Image
                            ...
                            alt="New site picture 1 preview"
                            maxH="200px"
                            w="100%"
                            objectFit="cover"
                            borderRadius="md"
                  ...
                  {/* Picture 2 - Only shown if Picture 1 exists (current or new) */}
                  {(currentImages.sitePicture1 ||
                    previewImages.sitePicture1) && (
                    <FormControl
                      isInvalid={
                      ...
                      {currentImages.sitePicture2 &&
                        !previewImages.sitePicture2 && (
                          <Box position="relative" mb={3}>
                            ...
                            <Image
                              src={currentImages.sitePicture2}
                              alt="Current site picture 2"
                              maxH="200px"
                              w="100%"
                              objectFit="cover"
                              borderRadius="md"
                        ...
                        <Box>
                          ...
                          <Box position="relative">
                            <Image
                              ...
                              alt="New site picture 2 preview"
                              maxH="200px"
                              w="100%"
                              objectFit="cover"
                              borderRadius="md"
                  ...
                  {/* Picture 3 - Only shown if Picture 2 exists (current or new) */}
                  {(currentImages.sitePicture1 || previewImages.sitePicture1) &&
                    (currentImages.sitePicture2 ||
                      previewImages.sitePicture2) && (
                      <FormControl
                        isInvalid={
                      ...
                      >
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handlePictureChange("sitePicture3", e)
                          }
                          display="none"
                        />

                        {/* Current Image Display */}
                        {currentImages.sitePicture3 &&
                          !previewImages.sitePicture3 && (
                            <Box position="relative" mb={3}>
                              ...
                              <Image
                                src={currentImages.sitePicture3}
                                alt="Current site picture 3"
                                maxH="200px"
                                w="100%"
                                objectFit="cover"
                                borderRadius="md"
                          ...
                          <Box>
                            ...
                            <Box position="relative">
                              <Image
                                ...
                                alt="New site picture 3 preview"
                                maxH="200px"
                                w="100%"
                                objectFit="cover"
                                borderRadius="md"
...
export async function siteLoader({ params }) {
...
export async function action({ request, params }) {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      return {
        error: true,
        message: errorData.message || "Failed to update site",
        details: errorData,
      };
    }
    ...
    return {
      error: true,
      message: "Network error occurred while updating site",
